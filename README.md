...
- `dist/Environment Setup Center-0.1.0-x86_64.AppImage`
- `dist/Environment Setup Center-0.1.0-amd64.deb`
...
```bash
sudo apt install ./dist/Environment\ Setup\ Center-0.1.0-amd64.deb
```
